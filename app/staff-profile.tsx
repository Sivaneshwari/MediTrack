...
/**
 * MediTrack Original Staff Profile (Version 1)
                ...
                <ScrollView contentContainerStyle={styles.content}>
                    ...
                    <View style={styles.profileHero}>
                        <View style={styles.avatarLarge}>
                            <Ionicons name="medical" size={60} color="#2ecc71" />
                        </View>
                        <Text style={styles.profileName}>{profile?.full_name || "Staff Member"}</Text>
                        <Text style={styles.profileId}>ID: {profile?.staff_id}</Text>
                    </View>
                    ...
                    <View style={styles.infoGrid}>
                        <View style={styles.infoBox}>
                            ...
                            <Text style={styles.infoValue}>{profile?.department || "General Clinic"}</Text>
                        </View>
                        <View style={styles.infoBox}>
                            <Text style={styles.infoLabel}>SHIFT</Text>
                            <Text style={styles.infoValue}>{profile?.shift || "Standard"}</Text>
                        </View>
                    </View>

                    {/* Personal Stats (Blood Group for Staff too) */}
                    ...
                    <View style={styles.medGrid}>
                        <View style={styles.medItem}>
                            ...
                            <Text style={styles.medValue}>{profile?.blood_group || "N/A"}</Text>
                        ...
                        <View style={styles.medItem}>
                            ...
                            <Text style={styles.medValue}>{profile?.dob || "N/A"}</Text>
                            <Text style={styles.medLabel}>Date of Birth</Text>
                        </View>
                    </View>

                    <TouchableOpacity style={styles.secondaryBtn}>
                        <Ionicons name="settings-outline" size={20} color={COLORS.textLight} />
                        <Text style={styles.secondaryBtnText}>Staff Settings</Text>
                    </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    avatarLarge: { width: 120, height: 120, borderRadius: 60, backgroundColor: '#f5f5f5', justifyContent: 'center', alignItems: 'center', marginBottom: 20, borderWidth: 4, borderColor: '#2ecc71' },
    ...
    infoBox: { flex: 1, backgroundColor: '#f8f9fa', padding: 16, borderRadius: 16 },
    ...
    medItem: { flex: 1, backgroundColor: 'white', padding: 20, borderRadius: 20, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 5, elevation: 2, borderWidth: 1, borderColor: COLORS.tabBackground },
    medIcon: { width: 48, height: 48, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginBottom: 12 },
    medValue: { fontSize: 16, fontWeight: '800', color: COLORS.text },
    medLabel: { fontSize: 12, color: COLORS.textLight, fontWeight: '600', marginTop: 4 },
    secondaryBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, paddingVertical: 16, borderRadius: 16, borderWidth: 1, borderColor: COLORS.tabBackground },
